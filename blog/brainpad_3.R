...
# - 3. 構築したモデルをテストデータに適用して、ユーザのレーティングや購買を予測
# - 4. どの程度正確に言い当てられるかを評価

# ［課題］
# - アウトオブサンプル評価として適切なのかは議論の余地が残る
#   --- そもそも、オフライン評価はユーザー購入を予想して評価している（推奨の結果購入したとは限らない）
#   --- ユーザーがモデルの推奨にかかわらず購入する
